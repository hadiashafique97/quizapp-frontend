...
function TestInstructions({ testData, setView }) {
    return (
        <div className='flex flex-col'>
            ...
            <div className='tile ptop1'>
                <ol className="flex flex-col gap1">
                    ...
                    <li> Test will automatically be submitted once the {testData.duration} minutes <i className="ri-timer-fill"></i> has timed out</li>
            ...
            <div className='flex justify-end ptop2'>
                <button className='create-button' onClick={() => setView("questions")}> Start Test</button>
            </div>
